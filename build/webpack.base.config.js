...
const component = customConfigInfo.component  // 领域标识

const rootPath =  path.join(__dirname, '../')
const getEntrys = multipe.getEntrys

// 控件目录
const ctrlPath = `./src/${client}/isv/${isv}/${moduleId}/${component}`
//根据具体目录结构来确定路径
...
module.exports = {
    ...
    module:{
        rules:[{
            ...
            //loader: 'url-loader?limit=1024&name=[path]/[name]/[name].[ext]'
            //loader: 'url-loader?limit=1024&name=[path][name].[ext]&outputPath=`${component}`/img/&publicPath=output/'
        },{
            test:/\.(css|less)$/,
